...
:::caution[Pre-1.0]
Still pre-1.0. Pin `harnery@^0.31.0` and skim the [CHANGELOG](https://github.com/ryanjkelly/harnery/blob/main/CHANGELOG.md) before upgrading; see [Install](/getting-started/install/).
:::
...
Visit `http://localhost:4276`. Live updates via Server-Sent Events whenever the coord state changes. See [concepts / web UI](/concepts/web-ui/) for the full feature tour.
...
# Take a snapshot of the durable V3 ledger and coordination state
