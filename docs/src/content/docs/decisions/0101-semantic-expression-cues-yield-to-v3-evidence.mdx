...
ADR 0102 supersedes this explicit-start policy after the operator chose to run
the reader continuously and improve it from live evidence. The cue precedence,
privacy filter, validation, and failure fallbacks in this ADR do not change.
