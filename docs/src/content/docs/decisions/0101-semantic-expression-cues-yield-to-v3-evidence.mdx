...
The semantic read-model and prompt contracts move to version 2.
...
passes 128 tests. TypeScript typecheck passes. The service remains
explicit-start while live harness proof and the measured expression cohort run.
