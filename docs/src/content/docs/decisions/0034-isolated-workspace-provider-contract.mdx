...
description: "ADR: add an optional workspace-provider contract without replacing durable work, proof, policy, approval, or governor authority."
---
...
policy checks, approvals, and governor projections. Those records decide
...
.harnery/
  ...
  governors/...                           governor projections
...
- The governor remains a projection over work and proof; it gains no
...
Isolation can be added without changing governor scheduling or shared
