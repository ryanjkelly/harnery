...
[`harn browse-ai`](/cli/browse-ai/), [`harn fetch`](/cli/fetch/), and the [`harn browse-session`](/cli/browse-session/) navigation verbs share the same gate and controls. Embedding hosts can pace their own page loaders through `harnery/lib/pace`. Decision record: [ADR 0184](/decisions/0184-read-pages-at-human-pace/).
