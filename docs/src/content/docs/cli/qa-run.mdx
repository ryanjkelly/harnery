...
.harnery/artifacts/<date>_qa-run_<artifact-id>/
  ...
  run-<run_id>/
    ...
    pack/                     # the page review pack (see harn review-pack)
      ...
      contexts/<id>/          # full-page.png, tiles/T001.png…, dom.html, signature.json
```
