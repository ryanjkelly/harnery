...
Working artifacts sit between the scratch journal and tracked project files.
...
## Scratch, artifacts, and durable files

Use `harn scratch` for short text breadcrumbs that help with context recovery
