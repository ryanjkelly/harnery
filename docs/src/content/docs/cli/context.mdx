---
title: harn agents context
description: One-shot orientation snapshot of who you are, the repo, and your active peers.
sidebar:
  order: 8
---

```
harn agents context [options]
```
...
harn agents context --section self,peers

# Add the opt-in docker compose section
harn agents context --include services

# Show clean submodules too, as JSON
harn agents context --show-clean --json
```
...
Continuity capsules moved to [`harn checkpoint`](../checkpoint/).
